 ...
 */
public record EmbeddedNodeInfo(NetworkType networkType, String jarFileName, EmbeddedFullNode.LogLevel logLevel, String confFileName, boolean autoUpdate, List<String> vmArguments) {
